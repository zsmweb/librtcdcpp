...
altered_lines = ['' if line.startswith('#include ') or line.startswith('#pragma') or line.startswith('extern') or line.startswith('typedef struct rtcdcpp::') or line.startswith('#if') or line.startswith('#e') else line for line in lines]
